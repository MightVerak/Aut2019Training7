...
class FormationsPositionTitlesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'formation_status_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        '_indexes' => [
        ...
        '_constraints' => [
            ...
            'formations_position_titles_ibfk_2' => ['type' => 'foreign', 'columns' => ['formation_id'], 'references' => ['formations', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
