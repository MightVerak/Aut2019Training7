...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Position Title Of Formation'), ['action' => 'edit', $positionTitleOfFormation->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Position Title Of Formation'), ['action' => 'delete', $positionTitleOfFormation->id], ['confirm' => __('Are you sure you want to delete # {0}?', $positionTitleOfFormation->id)]) ?> </li>
...
<div class="positionTitleOfFormations view large-9 medium-8 columns content">
    <h3><?= h($positionTitleOfFormation->title) ?></h3>
    ...
    <div class="related">
        ...
        <?php if (!empty($positionTitleOfFormation->formations)): ?>
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($positionTitleOfFormation->formations as $formations): ?>
            <tr>
