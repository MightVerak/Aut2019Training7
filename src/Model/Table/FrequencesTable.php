 ...
 * @method \App\Model\Entity\Frequence newEntity($data = null, array $options = [])
 ...
 * @method \App\Model\Entity\Frequence[] patchEntities($entities, array $data, array $options = [])
...
class FrequencesTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->setDisplayField('frequence');
